		...
		methods: {
			...
			filterElementsByText() {
				this.contacts.forEach((element) => {
					const userLowSearch = this.searchFilter.toLowerCase();
					const elementTextLower = element.name.toLowerCase();

					if(elementTextLower.includes(userLowSearch)) {
